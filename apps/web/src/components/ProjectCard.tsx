    ...
    <div>
      ...
      {project.websiteUrl && (
        <a
          ...
          className="mt-2 inline-flex items-center gap-1 text-sm text-black/60 underline decoration-black/20 underline-offset-2 hover:text-black hover:decoration-black"
        >
          Visit live site &#8599;
        </a>
      )}
